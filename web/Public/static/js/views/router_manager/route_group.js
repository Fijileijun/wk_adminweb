...
class RouteGroupView extends BaseView {
    ...
    goToGrayDivide(record){
        gotoPage(__mei_wei__.env.basepath + '/router_manager/gray_divide?group_id='+record.id+'&host_id='+record.host_id +'&gateway_id='+record.gateway_id);
    }
