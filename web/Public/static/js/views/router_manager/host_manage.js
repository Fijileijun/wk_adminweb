...
class HostManageView extends BaseView {
    ...
    goApiGroup(record) {
        gotoPage(__mei_wei__.env.basepath + '/router_manager/route_group?host_id=' + record.id + '&gateway_id=' + record.gateway_id);
    }
