...
class PluginGeneralView extends BaseView {
    ...
    toggleEnable(item,idx){
        ...
        togglePluginEnableModel.url =  __mei_wei__.env.restfulapi + item.plugin_name + '/enable';
...
module.exports = PluginGeneralView;